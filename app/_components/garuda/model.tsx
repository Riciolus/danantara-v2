...
//     return {
//       particle: new THREE.TextureLoader().load("/images/header/glowv2.png"),
//       smoke: new THREE.TextureLoader().load("/images/header/cloud3.png"),
//     };
//   }, []);
